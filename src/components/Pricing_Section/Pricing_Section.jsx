  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Responsive Grid: 
            items-stretch নিশ্চিত করে যে সব কার্ডের হাইট সমান হবে */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="flex flex-col bg-white border hover:lg:scale-105  border-gray-100 shadow-sm p-8 rounded-[20px] transition-all hover:shadow-md">
            <div className="grow">
              ...
              <div className="my-8">
                ...
                <span className="text-gray-400 font-medium ml-1">/Month</span>
              </div>
            ...
            {/* Button stays at the bottom because of flex-grow above */}
          ...
          <div className="relative flex flex-col bg-[#7C3AED] shadow-2xl p-8 rounded-[20px] text-white border-none hover:lg:scale-105 transition-all z-10">
            ...
            <div className="grow">
              ...
              <p className="text-indigo-100 text-sm mt-1">Best for professionals</p>
